...
nM1 = 50
nM2 = 50
#shared bin numbers for m1 and m2, n(n+1)/2 steps rather than n2, takes care of overestimation by factor 2
nMComb = 25 
nMT = 5
ndim = nMT
nwak = 30
...
pickleRick.dump(NBinned, pickle_out)
pickle_out.close()
...
NBinned = pickleRick.load(pickle_in)
